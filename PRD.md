...
### 2.4. 캐릭터 진화 스펙 (별 성장 테마)

캐릭터는 습관 완료를 통해 EXP를 획득하며, 레벨에 따라 5단계로 진화한다.

| 단계 | 레벨 | 이름 | 설명 |
|------|------|------|------|
| 1 | 1-4 | 별먼지 | 작고 반짝이는 먼지, 졸린 눈 |
| 2 | 5-9 | 작은 별 | 작은 별 모양, 호기심 많은 표정 |
| 3 | 10-19 | 반짝 별 | 빛나는 별, 밝은 표정 |
| 4 | 20-34 | 큰 별 | 큰 별 캐릭터, 악세서리 착용 |
| 5 | 35+ | 별자리 | 별자리 형태, 마법 이펙트 |

**EXP 공식:**
- 습관 완료: +10 EXP
- 스트릭 보너스: 연속일 × 2 EXP (최대 +20)
- 레벨업 기준: `level × 100` EXP

### 2.5. 초강력 위젯 (Widget-First UX)
...
- **주요 컬러:** - Primary: #FFB6C1 (Soft Pink)
    - Secondary: #E6E6FA (Lavender)
    - Tertiary: #F0FFF0 (Creamy Mint)
